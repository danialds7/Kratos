...
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) DamageCl
...
public:
    ...
    /// Counted pointer of DamageCl
    KRATOS_CLASS_POINTER_DEFINITION(DamageCl);
    ...
    */
    ...
    {
        return Kratos::make_shared<DamageCl<TConstLawIntegratorType>>(*this);
    }

    /**
    * Copy constructor.
    */
    DamageCl(const DamageCl &rOther)
        : BaseType(rOther),
