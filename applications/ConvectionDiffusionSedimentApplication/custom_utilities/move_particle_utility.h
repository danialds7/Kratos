	...
	public:
		...
		MoveParticleUtilityScalarTransport(ModelPart& model_part, int maximum_number_of_particles)
			: mr_model_part(model_part) , mmaximum_number_of_particles(maximum_number_of_particles) ,
			 mUnknownVar((model_part.GetProcessInfo()[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS])->GetUnknownVariable()) ,
			 mProjectionVar((model_part.GetProcessInfo()[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS])->GetProjectionVariable()) ,
			 mVelocityVar((model_part.GetProcessInfo()[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS])->GetVelocityVariable()) ,
			 mMeshVelocityVar((model_part.GetProcessInfo()[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS])->GetMeshVelocityVariable())
		{
