...
#include "qs_convection_diffusion_sediment_explicit.h"
...
QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::QSConvectionDiffusionSedimentExplicit(
    IndexType NewId,
...
template< unsigned int TDim, unsigned int TNumNodes >
Element::Pointer QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::Create(
    IndexType NewId,
    NodesArrayType const& ThisNodes,
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<QSConvectionDiffusionSedimentExplicit>(NewId, this->GetGeometry().Create(ThisNodes), pProperties);
}
...
Element::Pointer QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::Create(
    ...
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<QSConvectionDiffusionSedimentExplicit>(NewId, pGeom, pProperties);
}
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::CalculateLocalSystem(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
    KRATOS_ERROR << "Calling the CalculateLocalSystem() method for the explicit Convection-Diffusion-Sediment element.";
    KRATOS_CATCH("");
}
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::CalculateRightHandSide(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
    KRATOS_ERROR << "Calling the CalculateRightHandSide() method for the explicit Convection-Diffusion-Sediment element. Call the QSCalculateRightHandSideInternal() method instead.";
    KRATOS_CATCH("");
}
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::EquationIdVector(
    EquationIdVectorType& rResult,
    const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY;

    ConvectionDiffusionSedimentSettings::Pointer p_settings = rCurrentProcessInfo.GetValue(CONVECTION_DIFFUSION_SEDIMENT_SETTINGS);
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::GetDofList(
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::AddExplicitContribution(
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
    ...
    const auto& reaction_variable = r_process_info[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS]->GetReactionVariable();
...
template <>
void QSConvectionDiffusionSedimentExplicit<2,3>::CalculateMassMatrix(
...
template <>
void QSConvectionDiffusionSedimentExplicit<3,4>::CalculateMassMatrix(
    MatrixType &rMassMatrix,
    const ProcessInfo &rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::CalculateLumpedMassVector(
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::Calculate(
    ...
    const ProcessInfo& rCurrentProcessInfo)
{
    ...
    const ProcessInfo& r_process_info = rCurrentProcessInfo;
    ConvectionDiffusionSedimentSettings::Pointer p_settings = r_process_info[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS];
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::InitializeEulerianElement(
    ElementData& rData,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template <>
void QSConvectionDiffusionSedimentExplicit<2,3>::QSCalculateRightHandSideInternal(
...
template <>
void QSConvectionDiffusionSedimentExplicit<3,4>::QSCalculateRightHandSideInternal(
...
template <>
void QSConvectionDiffusionSedimentExplicit<2,3>::QSCalculateOrthogonalSubgridScaleRHSInternal(
    BoundedVector<double, 3>& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template <>
void QSConvectionDiffusionSedimentExplicit<3,4>::QSCalculateOrthogonalSubgridScaleRHSInternal(
    BoundedVector<double, 4>& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template< unsigned int TDim, unsigned int TNumNodes >
double QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::ComputeH(
...
template< unsigned int TDim, unsigned int TNumNodes >
void QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::QSCalculateTau(
    ElementData& rData)
{
    KRATOS_TRY;
...
template< unsigned int TDim, unsigned int TNumNodes >
Element::IntegrationMethod QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::GetIntegrationMethod() const
{
...
template class QSConvectionDiffusionSedimentExplicit<2,3>;
template class QSConvectionDiffusionSedimentExplicit<3,4>;
