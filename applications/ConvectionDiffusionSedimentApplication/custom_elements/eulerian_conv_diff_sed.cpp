...
//----------------------------------------------------------------------------------------
    ...
    void EulerianConvectionDiffusionSedimentElement< TDim, TNumNodes >::EquationIdVector(EquationIdVectorType& rResult, const ProcessInfo& rCurrentProcessInfo) const
    {
        KRATOS_TRY
...
//----------------------------------------------------------------------------------------
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
    void EulerianConvectionDiffusionSedimentElement< TDim, TNumNodes >::GetDofList(DofsVectorType& ElementalDofList, const ProcessInfo& rCurrentProcessInfo) const
    {
        KRATOS_TRY
...
//----------------------------------------------------------------------------------------
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
    void EulerianConvectionDiffusionSedimentElement<TDim,TNumNodes>::CalculateLocalSystem(Matrix& rLeftHandSideMatrix,
...
//----------------------------------------------------------------------------------------
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
    void EulerianConvectionDiffusionSedimentElement<TDim,TNumNodes>::InitializeEulerianElement(ElementVariables& rVariables, const ProcessInfo& rCurrentProcessInfo)
    {
        KRATOS_TRY
...
//----------------------------------------------------------------------------------------
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
    void EulerianConvectionDiffusionSedimentElement<TDim,TNumNodes>::CalculateGeometry(BoundedMatrix<double,TNumNodes,TDim>& rDN_DX, double& rVolume)
    {
...
//----------------------------------------------------------------------------------------
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
    double EulerianConvectionDiffusionSedimentElement< TDim, TNumNodes >::ComputeH(BoundedMatrix<double,TNumNodes,TDim >& DN_DX)
    {
        double h=0.0;
...
//----------------------------------------------------------------------------------------
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
    void EulerianConvectionDiffusionSedimentElement<TDim,TNumNodes>::GetNodalValues(ElementVariables& rVariables, const ProcessInfo& rCurrentProcessInfo) const
    {
        ConvectionDiffusionSedimentSettings::Pointer my_settings = rCurrentProcessInfo.GetValue(CONVECTION_DIFFUSION_SEDIMENT_SETTINGS);
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
double EulerianConvectionDiffusionSedimentElement<TDim,TNumNodes>::CalculateTau(const ElementVariables& rVariables, double norm_vel, double h)
{
    // Dynamic part
...
//----------------------------------------------------------------------------------------
    ...
    template< unsigned int TDim, unsigned int TNumNodes >
    void EulerianConvectionDiffusionSedimentElement< TDim, TNumNodes >::CalculateRightHandSide(
...
template class EulerianConvectionDiffusionSedimentElement<2,3>;
template class EulerianConvectionDiffusionSedimentElement<2,4>;
template class EulerianConvectionDiffusionSedimentElement<3,4>;
template class EulerianConvectionDiffusionSedimentElement<3,8>;
