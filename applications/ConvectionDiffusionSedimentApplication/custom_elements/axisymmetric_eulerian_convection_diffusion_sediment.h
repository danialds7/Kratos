...
#include "eulerian_conv_diff_sed.h"
...
class KRATOS_API(CONVECTION_DIFFUSION_SEDIMENT_APPLICATION) AxisymmetricEulerianConvectionDiffusionSedimentElement
    : public EulerianConvectionDiffusionSedimentElement<TDim, TNumNodes>
{
public:
    ...
    /// Pointer definition of AxisymmetricEulerianConvectionDiffusionSedimentElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(AxisymmetricEulerianConvectionDiffusionSedimentElement);

    /// Base convection-diffusion-sediment element type
    using BaseType = EulerianConvectionDiffusionSedimentElement<TDim, TNumNodes>;
    ...
    /// Constructors.
    AxisymmetricEulerianConvectionDiffusionSedimentElement() : BaseType()
    {
    }

    AxisymmetricEulerianConvectionDiffusionSedimentElement(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~AxisymmetricEulerianConvectionDiffusionSedimentElement(){};
    ...
    {
        return Kratos::make_intrusive<AxisymmetricEulerianConvectionDiffusionSedimentElement<TDim, TNumNodes>>(NewId, this->GetGeometry().Create(ThisNodes), pProperties);
    }
    ...
    Element::Pointer Create(
        ...
        typename PropertiesType::Pointer pProperties) const override
    {
        return Kratos::make_intrusive<AxisymmetricEulerianConvectionDiffusionSedimentElement<TDim, TNumNodes>>(NewId, pGeom, pProperties);
    }
    ...
    {
        return "AxisymmetricConvectionDiffusionSediment #";
    }
...
private:
    ...
    ///@}
}; // Class AxisymmetricConvectionDiffusionSediment

///@}

///@} // ConvectionDiffusionSedimentApplication group
