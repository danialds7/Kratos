...
#include "axisymmetric_eulerian_convection_diffusion_sediment.h"

namespace Kratos
{

template< unsigned int TDim, unsigned int TNumNodes >
void AxisymmetricEulerianConvectionDiffusionSedimentElement<TDim,TNumNodes>::CalculateLocalSystem(
...
template< unsigned int TDim, unsigned int TNumNodes >
void AxisymmetricEulerianConvectionDiffusionSedimentElement< TDim, TNumNodes >::CalculateRightHandSide(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    // Resize of RHS array
...
template< unsigned int TDim, unsigned int TNumNodes >
int AxisymmetricEulerianConvectionDiffusionSedimentElement< TDim, TNumNodes >::Check(const ProcessInfo &rCurrentProcessInfo) const
{
    // Base element check
...
template <unsigned int TDim, unsigned int TNumNodes>
double AxisymmetricEulerianConvectionDiffusionSedimentElement<TDim, TNumNodes>::CalculateTau(
...
template <unsigned int TDim, unsigned int TNumNodes>
void AxisymmetricEulerianConvectionDiffusionSedimentElement<TDim, TNumNodes>::CalculateGaussPointData(
...
template class AxisymmetricEulerianConvectionDiffusionSedimentElement<2,3>;
template class AxisymmetricEulerianConvectionDiffusionSedimentElement<2,4>;
