...
int AdjointDiffusionElement<PrimalElement>::Check(const ProcessInfo& rProcessInfo) const
{
    ...
    KRATOS_ERROR_IF_NOT(rProcessInfo.Has(CONVECTION_DIFFUSION_SEDIMENT_SETTINGS)) << "No CONVECTION_DIFFUSION_SEDIMENT_SETTINGS defined in ProcessInfo." << std::endl;
    ConvectionDiffusionSedimentSettings::Pointer p_settings = rProcessInfo[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS];
