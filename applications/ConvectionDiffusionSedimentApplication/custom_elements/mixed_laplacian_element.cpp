...
{
    auto& r_settings = *(rCurrentProcessInfo[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS]);
    const auto& r_unknown_var = r_settings.GetUnknownVariable();
...
{
    KRATOS_ERROR_IF_NOT(rCurrentProcessInfo.Has(CONVECTION_DIFFUSION_SEDIMENT_SETTINGS)) << "No CONVECTION_DIFFUSION_SEDIMENT_SETTINGS defined in ProcessInfo." << std::endl;
    ConvectionDiffusionSedimentSettings::Pointer p_settings = rCurrentProcessInfo[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS];
    auto& r_settings = *p_settings;

    KRATOS_ERROR_IF_NOT(r_settings.IsDefinedUnknownVariable()) << "No Unknown Variable defined in provided CONVECTION_DIFFUSION_SEDIMENT_SETTINGS." << std::endl;
    KRATOS_ERROR_IF_NOT(r_settings.IsDefinedGradientVariable()) << "No Gradient Variable defined in provided CONVECTION_DIFFUSION_SEDIMENT_SETTINGS." << std::endl;
    KRATOS_ERROR_IF_NOT(r_settings.IsDefinedDiffusionVariable()) << "No Diffusion Variable defined in provided CONVECTION_DIFFUSION_SEDIMENT_SETTINGS." << std::endl;
    KRATOS_ERROR_IF_NOT(r_settings.IsDefinedVolumeSourceVariable()) << "No Volume Source Variable defined in provided CONVECTION_DIFFUSION_SEDIMENT_SETTINGS." << std::endl;
