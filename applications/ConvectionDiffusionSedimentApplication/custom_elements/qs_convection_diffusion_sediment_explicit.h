...
#ifndef KRATOS_QS_CONVECTION_DIFFUSION_SEDIMENT_EXPLICIT_H
#define KRATOS_QS_CONVECTION_DIFFUSION_SEDIMENT_EXPLICIT_H
...
/**
 * @class QSConvectionDiffusionSedimentExplicit
...
class QSConvectionDiffusionSedimentExplicit : public Element
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of QSConvectionDiffusionSedimentExplicit
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(QSConvectionDiffusionSedimentExplicit);
    ...
    //Constructors.
    QSConvectionDiffusionSedimentExplicit(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~QSConvectionDiffusionSedimentExplicit();
    ...
    {
        return "QSConvectionDiffusionSedimentExplicitElement #";
    }
...
protected:
    ...
    QSConvectionDiffusionSedimentExplicit() : Element()
    {
    }
...
private:
    ...
    /// Assignment operator
    QSConvectionDiffusionSedimentExplicit& operator=(QSConvectionDiffusionSedimentExplicit const& rOther) = delete;

    /// Copy constructor
    QSConvectionDiffusionSedimentExplicit(QSConvectionDiffusionSedimentExplicit const& rOther) = delete;
...
inline std::istream& operator >>(
    ...
    QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(
    ...
    const QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>& rThis)
{
...
#endif // KRATOS_QS_CONVECTION_DIFFUSION_SEDIMENT_EXPLICIT_H
