...
PYBIND11_MODULE(KratosConvectionDiffusionSedimentApplication,m)
{

    py::class_<KratosConvectionDiffusionSedimentApplication,
           KratosConvectionDiffusionSedimentApplication::Pointer,
           KratosApplication >(m,"KratosConvectionDiffusionSedimentApplication")
           .def(py::init<>())
           ;
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, C_SUSP_GRADIENT)
