...
/// A basic Neumann condition for convection-diffusion-sediment problems.
/** It applies a flux condition based on the nodal values of the
 *  variable defined as SurfaceSourceVariable by the
 *  CONVECTION_DIFFUSION_SEDIMENT_SETTINGS variable in the given ProcessInfo.
 */
class KRATOS_API(CONVECTION_DIFFUSION_SEDIMENT_APPLICATION) ThermalFace: public Condition
{
public:
