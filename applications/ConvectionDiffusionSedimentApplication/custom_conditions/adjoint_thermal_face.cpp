...
int AdjointThermalFace::Check(const ProcessInfo& rProcessInfo) const 
{
    ...
    KRATOS_ERROR_IF_NOT(r_settings.IsDefinedSurfaceSourceVariable()) << "No Surface Source Variable defined in provided CONVECTION_DIFFUSION_SEDIMENT_SETTINGS." << std::endl;
