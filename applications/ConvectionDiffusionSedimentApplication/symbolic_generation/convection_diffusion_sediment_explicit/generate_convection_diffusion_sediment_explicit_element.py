...
if dynamic_subscales:
    template_filename = "d_convection_diffusion_sediment_explicit_cpp_template.cpp"
else:
    template_filename = "qs_convection_diffusion_sediment_explicit_cpp_template.cpp"
templatefile = open(template_filename)
outstring = templatefile.read()

# Set the output filename
if template_filename == "d_convection_diffusion_sediment_explicit_cpp_template.cpp":
    output_filename = "d_convection_diffusion_sediment_explicit.cpp"
elif template_filename == "qs_convection_diffusion_sediment_explicit_cpp_template.cpp":
    output_filename = "qs_convection_diffusion_sediment_explicit.cpp"
else:
    err_msg = "Wrong template_filename provided. Must be (template --> output):\n"
    err_msg +=  "\t- d_convection_diffusion_sediment_explicit_cpp_template.cpp --> d_convection_diffusion_sediment_explicit.cpp\n"
    err_msg +=  "\t- qs_convection_diffusion_sediment_explicit_cpp_template.cpp --> qs_convection_diffusion_sediment_explicit.cpp"
    raise Exception(err_msg)
