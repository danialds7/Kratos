...
#include "d_convection_diffusion_sediment_explicit.h"
...
DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::DConvectionDiffusionSedimentExplicit(
    IndexType NewId,
    GeometryType::Pointer pGeometry)
    : QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>(NewId, pGeometry) {}
...
DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::DConvectionDiffusionSedimentExplicit(
    ...
    : QSConvectionDiffusionSedimentExplicit<TDim,TNumNodes>(NewId, pGeometry, pProperties) {}
...
template< unsigned int TDim, unsigned int TNumNodes >
Element::Pointer DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::Create(
    IndexType NewId,
    NodesArrayType const& ThisNodes,
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<DConvectionDiffusionSedimentExplicit>(NewId, this->GetGeometry().Create(ThisNodes), pProperties);
}
...
Element::Pointer DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::Create(
    ...
    Properties::Pointer pProperties) const
{
    return Kratos::make_intrusive<DConvectionDiffusionSedimentExplicit>(NewId, pGeom, pProperties);
}
...
template< unsigned int TDim, unsigned int TNumNodes >
void DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::CalculateLocalSystem(
...
template< unsigned int TDim, unsigned int TNumNodes >
void DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::CalculateRightHandSide(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
    KRATOS_ERROR << "Calling the CalculateRightHandSide() method for the explicit Convection-Diffusion-Sediment element. Call the DCalculateRightHandSideInternal() method instead.";
    KRATOS_CATCH("");
}
...
template< unsigned int TDim, unsigned int TNumNodes >
void DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::AddExplicitContribution(
    const ProcessInfo &rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template< unsigned int TDim, unsigned int TNumNodes >
void DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::Initialize(
    const ProcessInfo &rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template< unsigned int TDim, unsigned int TNumNodes >
void DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::FinalizeSolutionStep(
    const ProcessInfo &rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template< unsigned int TDim, unsigned int TNumNodes >
void DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::Calculate(
...
template <>
void DConvectionDiffusionSedimentExplicit<2,3>::DCalculateRightHandSideInternal(
...
template <>
void DConvectionDiffusionSedimentExplicit<3,4>::DCalculateRightHandSideInternal(
...
template <>
void DConvectionDiffusionSedimentExplicit<2,3>::DCalculateOrthogonalSubgridScaleRHSInternal(
    BoundedVector<double, 3>& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template <>
void DConvectionDiffusionSedimentExplicit<3,4>::DCalculateOrthogonalSubgridScaleRHSInternal(
    BoundedVector<double, 4>& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
...
template <>
void DConvectionDiffusionSedimentExplicit<2,3>::UpdateUnknownSubgridScaleGaussPoint(
    ElementData& rData,
    unsigned int g)
{
    KRATOS_TRY;
...
template <>
void DConvectionDiffusionSedimentExplicit<3,4>::UpdateUnknownSubgridScaleGaussPoint(
    ElementData& rData,
    unsigned int g)
{
    KRATOS_TRY;
...
template< unsigned int TDim, unsigned int TNumNodes >
void DConvectionDiffusionSedimentExplicit<TDim,TNumNodes>::DCalculateTau(
    ElementData& rData)
{
    KRATOS_TRY;
...
template class DConvectionDiffusionSedimentExplicit<2,3>;
template class DConvectionDiffusionSedimentExplicit<3,4>;
