...
class AdjointResponseFunction(ResponseFunctionInterface):
    ...
    def __init__(self, identifier, response_settings, model):
        ...
        self.primal_analysis = ConvectionDiffusionSedimentAnalysis(model, primal_parameters)
        ...
        self.adjoint_analysis = ConvectionDiffusionSedimentAnalysis(model, adjoint_parameters)
