...
import KratosMultiphysics.ConvectionDiffusionSedimentApplication as convdiff
...
class AdjointDiffusionSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        if self.model.HasModelPart(model_part_name):
            ...
            self.DefineConvectionDiffusionSedimentSettings(self.settings["convection_diffusion_sediment_variables"])
    ...
    def AddVariables(self):
        convection_diffusion_sediment_settings = self.model_part.ProcessInfo[kratos.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS]

        self.model_part.AddNodalSolutionStepVariable(convection_diffusion_sediment_settings.GetUnknownVariable())
        self.model_part.AddNodalSolutionStepVariable(convection_diffusion_sediment_settings.GetDiffusionVariable())
        self.model_part.AddNodalSolutionStepVariable(convection_diffusion_sediment_settings.GetVolumeSourceVariable())
        self.model_part.AddNodalSolutionStepVariable(convection_diffusion_sediment_settings.GetSurfaceSourceVariable())
    ...
    def DefineConvectionDiffusionSedimentSettings(self,settings):
        convection_diffusion_sediment_settings = kratos.ConvectionDiffusionSedimentSettings()

        convection_diffusion_sediment_settings.SetDiffusionVariable(
            kratos.KratosGlobals.GetVariable(settings["diffusion_variable"].GetString()))
        convection_diffusion_sediment_settings.SetUnknownVariable(
            kratos.KratosGlobals.GetVariable(settings["unknown_variable"].GetString()))
        convection_diffusion_sediment_settings.SetVolumeSourceVariable(
            kratos.KratosGlobals.GetVariable(settings["volume_source_variable"].GetString()))
        convection_diffusion_sediment_settings.SetSurfaceSourceVariable(
            kratos.KratosGlobals.GetVariable(settings["surface_source_variable"].GetString()))

        self.model_part.ProcessInfo.SetValue(kratos.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS,convection_diffusion_sediment_settings)
