...
def CreateSolver(main_model_part, custom_settings):
    return ConvectionDiffusionSedimentStationaryMatrixSolver(main_model_part, custom_settings)


class ConvectionDiffusionSedimentStationaryMatrixSolver(convection_diffusion_sediment_stationary_solver.ConvectionDiffusionSedimentStationarySolver):

    """Variant of the stationary convection diffusion sediment solver that extracts:
    ...
    def __init__(self, main_model_part, custom_settings):
        ...
        super(ConvectionDiffusionSedimentStationaryMatrixSolver, self).__init__(main_model_part, custom_settings)
