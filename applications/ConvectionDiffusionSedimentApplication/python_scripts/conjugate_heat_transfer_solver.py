...
import KratosMultiphysics.ConvectionDiffusionSedimentApplication as KratosConvDiff
...
class ConjugateHeatTransferSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        self.fluid_thermal_solver = python_solvers_wrapper_convection_diffusion_sediment.CreateSolverByParameters(self.model, self.settings["fluid_domain_solver_settings"]["thermal_solver_settings"], "OpenMP")
        self.solid_thermal_solver = python_solvers_wrapper_convection_diffusion_sediment.CreateSolverByParameters(self.model, self.settings["solid_domain_solver_settings"]["thermal_solver_settings"], "OpenMP")
    ...
    def ImportModelPart(self):
        ...
        # is the case if the default one in the convection diffusion sediment is taken.
        ...
        # Save the convection diffusion sediment settings
        convection_diffusion_sediment_settings = self.fluid_thermal_solver.main_model_part.ProcessInfo.GetValue(KratosMultiphysics.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS)
        ...
        # Set the saved convection diffusion sediment settings to the new thermal model part
        self.fluid_thermal_solver.main_model_part.ProcessInfo.SetValue(KratosMultiphysics.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS, convection_diffusion_sediment_settings)
