...
def CreateSolver(main_model_part, custom_settings):
    return ConvectionDiffusionSedimentStationaryShiftedBoundarySolver(main_model_part, custom_settings)

class ConvectionDiffusionSedimentStationaryShiftedBoundarySolver(convection_diffusion_sediment_stationary_solver.ConvectionDiffusionSedimentStationarySolver):
    ...
    def _get_element_condition_replace_settings(self):
        ...
        if condition_name != "":
            KratosMultiphysics.Logger.PrintWarning("ConvectionDiffusionSedimentStationaryShiftedBoundarySolver", "Ignoring provided condition \'{}\'.".format(condition_name))
