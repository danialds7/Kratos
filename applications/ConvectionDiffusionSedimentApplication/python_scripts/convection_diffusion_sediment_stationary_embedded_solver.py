...
from KratosMultiphysics.ConvectionDiffusionSedimentApplication import convection_diffusion_sediment_stationary_solver

def CreateSolver(main_model_part, custom_settings):
    return ConvectionDiffusionSedimentStationaryEmbeddedSolver(main_model_part, custom_settings)

class ConvectionDiffusionSedimentStationaryEmbeddedSolver(convection_diffusion_sediment_stationary_solver.ConvectionDiffusionSedimentStationarySolver):
    """The embedded class for a stationary convection-diffusion-sediment solvers.
    ...
    def Initialize(self):
        ...
        if self.settings["use_mls_constraints"].GetBool():
            if self.settings["use_distance_modification"].GetBool():
                KratosMultiphysics.Logger.PrintWarning("ConvectionDiffusionSedimentStationaryEmbeddedSolver", "Giving precedence to MLS constraints over distance modification")
            ...
            settings.AddEmptyValue("unknown_variable").SetString(self.settings["convection_diffusion_sediment_variables"]["unknown_variable"].GetString())
            ...
            constraint_process = ConvectionDiffusionSedimentApplication.EmbeddedMLSConstraintProcess(self.model, settings)
