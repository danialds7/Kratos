...
def CreateSolverByParameters(model, solver_settings, parallelism):
    ...
    if (parallelism == "OpenMP"):
        ...
        if (solver_type == "transient" or solver_type == "Transient"):
            ...
            if time_integration_method == "implicit":
                solver_module_name = "convection_diffusion_sediment_transient_solver"
            elif time_integration_method == "explicit":
                solver_module_name = "convection_diffusion_sediment_explicit_solver"
            elif time_integration_method == "semi_implicit":
                solver_module_name = "convection_diffusion_sediment_semi_eulerian_solver"
            else:
        ...
        # Steady solver
            ...
            solver_module_name = "convection_diffusion_sediment_stationary_solver"
        # Steady Shifted Boundary Method (SBM) solver
        elif solver_type == "stationary_shifted_boundary":
            solver_module_name = "convection_diffusion_sediment_stationary_shifted_boundary_solver"
        # Steady embedded (CutFEM) solver
        elif solver_type == "stationary_embedded":
            solver_module_name = "convection_diffusion_sediment_stationary_embedded_solver"
        # Auxiliary solver to generate the stationary system matrix
        elif (solver_type == "stationary_matrix"):
            solver_module_name = "convection_diffusion_sediment_stationary_matrix_solver"
    ...
    module_full = 'KratosMultiphysics.ConvectionDiffusionSedimentApplication.' + solver_module_name
