...
class CoupledThermoMechanicalSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        self.thermal_solver = python_solvers_wrapper_convection_diffusion_sediment.CreateSolverByParameters(self.model,self.settings["thermal_solver_settings"],"OpenMP")
    ...
    def PrepareModelPart(self):
        ...
        convection_diffusion_sediment_settings = self.thermal_solver.main_model_part.ProcessInfo.GetValue(KratosMultiphysics.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS)
        ...
        self.thermal_solver.main_model_part.ProcessInfo.SetValue(KratosMultiphysics.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS, convection_diffusion_sediment_settings)
