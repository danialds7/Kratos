...
from KratosMultiphysics.ConvectionDiffusionSedimentApplication import *        #and now our application. note that we can import as many as we need to solve our specific problem 

#import eulerian_convection_diffusion_sediment_solver as convection_diffusion_sediment_solver
#import pfem2_convection_diffusion_sediment_solver as convection_diffusion_sediment_solver
import bfecc_convection_diffusion_sediment_solver as convection_diffusion_sediment_solver
...
#THERE ARE TWO WAYS TO DEFINE THE CONVECTION DIFFUSION SEDIMENT SETTINGS.
...
ConvDiffSettings = ProjectParameters.ConvectionSolverSettings
convection_diffusion_sediment_solver.AddVariables(model_part, ConvDiffSettings)

#OPTION 2 is aimed at developers. The CONVECTION_DIFFUSION_SEDIMENT_SETTINGS of the model_part are defined by the user in this file
#then the AddVariables will read the values directly from the model part: 
#thermal_settings = ConvectionDiffusionSedimentSettings()
...
#(model_part.ProcessInfo).SetValue(CONVECTION_DIFFUSION_SEDIMENT_SETTINGS, thermal_settings)
#eulerian_convection_diffusion_sediment_solver.AddVariables(model_part) # no settings here! (read from the model_part)
...
convection_diffusion_sediment_solver.AddDofs(model_part)
...
convection_solver = convection_diffusion_sediment_solver.CreateSolver(model_part, ProjectParameters)
