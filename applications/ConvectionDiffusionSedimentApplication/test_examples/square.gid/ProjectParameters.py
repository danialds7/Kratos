...
class SolverSettings2:
    solver_type = "nonlinear_convection_diffusion_sediment_solver"
    domain_size = 2
    time_order = 2
    predictor_corrector = False
    ReformDofAtEachIteration = False
...
problem_name = "square"
problem_path = "/home/julio.marti/new_kratos/applications/convection_diffusion_sediment_application/test_examples/square.gid"
kratos_path = "../../../.."
