...
#include "convection_diffusion_sediment_application.h"
...
KratosConvectionDiffusionSedimentApplication::KratosConvectionDiffusionSedimentApplication()
    : KratosApplication("ConvectionDiffusionSedimentApplication"),


      mAxisymmetricEulerianConvectionDiffusionSediment2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node >(Element::GeometryType::PointsArrayType(3)))),
      mAxisymmetricEulerianConvectionDiffusionSediment2D4N(0, Element::GeometryType::Pointer(new Quadrilateral2D4<Node >(Element::GeometryType::PointsArrayType(4)))),
      ...
      mQSConvectionDiffusionSedimentExplicit2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node >(Element::GeometryType::PointsArrayType(3)))),
      mQSConvectionDiffusionSedimentExplicit3D4N(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node >(Element::GeometryType::PointsArrayType(4)))),
      mDConvectionDiffusionSedimentExplicit2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node >(Element::GeometryType::PointsArrayType(3)))),
      mDConvectionDiffusionSedimentExplicit3D4N(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node >(Element::GeometryType::PointsArrayType(4)))) {}

void KratosConvectionDiffusionSedimentApplication::Register() {
    KRATOS_INFO("") <<
    ...
    KRATOS_REGISTER_VARIABLE(C_SUSP)
    KRATOS_REGISTER_VARIABLE(C_SUSP_GRADIENT)
    KRATOS_REGISTER_VARIABLE(C_SUSP_FLUX)
    KRATOS_REGISTER_VARIABLE(C_SUSP_FACE_FLUX)

    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CONVECTION_VELOCITY)


    // Registering elements and conditions here
    KRATOS_REGISTER_ELEMENT("AxisymmetricEulerianConvectionDiffusionSediment2D3N", mAxisymmetricEulerianConvectionDiffusionSediment2D3N);
    KRATOS_REGISTER_ELEMENT("AxisymmetricEulerianConvectionDiffusionSediment2D4N", mAxisymmetricEulerianConvectionDiffusionSediment2D4N);
    ...
    KRATOS_REGISTER_ELEMENT("QSConvectionDiffusionSedimentExplicit2D3N", mQSConvectionDiffusionSedimentExplicit2D3N);
    KRATOS_REGISTER_ELEMENT("QSConvectionDiffusionSedimentExplicit3D4N", mQSConvectionDiffusionSedimentExplicit3D4N);
    KRATOS_REGISTER_ELEMENT("DConvectionDiffusionSedimentExplicit2D3N", mDConvectionDiffusionSedimentExplicit2D3N);
    KRATOS_REGISTER_ELEMENT("DConvectionDiffusionSedimentExplicit3D4N", mDConvectionDiffusionSedimentExplicit3D4N);
