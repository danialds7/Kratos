...
class ThermalCouplingTest(UnitTest.TestCase):
    ...
    def setUpModel(self,current_model):
        ...
        thermal_settings = KratosMultiphysics.ConvectionDiffusionSedimentSettings()
        ...
        self.left_model_part.ProcessInfo.SetValue(KratosMultiphysics.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS,thermal_settings)
        self.right_model_part.ProcessInfo.SetValue(KratosMultiphysics.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS,thermal_settings)

    def setUpSolvers(self):

        import convection_diffusion_sediment_solver as thermal_solver
        ...
        self.left_solver = thermal_solver.ConvectionDiffusionSedimentSolver(self.left_model_part,self.domain_size)
        ...
        self.right_solver = thermal_solver.ConvectionDiffusionSedimentSolver(self.right_model_part,self.domain_size)
