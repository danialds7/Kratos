...
from KratosMultiphysics.ConvectionDiffusionSedimentApplication.response_functions import convection_diffusion_sediment_response_function_factory
import KratosMultiphysics.KratosUnittest as KratosUnittest

import KratosMultiphysics.kratos_utilities as kratos_utils


class ConvectionDiffusionSedimentResponseFunctionTest(KratosUnittest.TestCase):
    ...
    def setUp(self):
        ...
        with KratosUnittest.WorkFolderScope(self.work_folder, __file__):
            ...
            self.response_function = convection_diffusion_sediment_response_function_factory.CreateResponseFunction("dummy", parameters["response_settings"], model)
...
class TestAdjointPointTemperatureResponseFunction(ConvectionDiffusionSedimentResponseFunctionTest):
