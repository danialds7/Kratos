...
from KratosMultiphysics.ConvectionDiffusionSedimentApplication import convection_diffusion_sediment_analysis
...
class SourceTermTestConvectionDiffusionSedimentAnalysis(convection_diffusion_sediment_analysis.ConvectionDiffusionSedimentAnalysis):
    """Derived convection-diffusion-sediment analysis stage to set the test material properties and boundary conditions."""
...
class SourceTermTest(KratosUnittest.TestCase):
    ...
    def testSourceTerm(self):
        with KratosUnittest.WorkFolderScope("SourceTermTest", __file__):
            ...
            ## Run test
            self.source_term_analysis = SourceTermTestConvectionDiffusionSedimentAnalysis(self.model, parameters, self.config)
