...
class ShiftedBoundarySolverAnnulusAnalysis(ConvectionDiffusionSedimentAnalysis):
    ...
    def ApplyBoundaryConditions(self):
        ...
        # Get variables
        conv_diff_sed_settings = self._GetSolver().GetComputingModelPart().ProcessInfo[KratosMultiphysics.CONVECTION_DIFFUSION_SEDIMENT_SETTINGS]
        unknown_variable = conv_diff_sed_settings.GetUnknownVariable()
        source_variable = conv_diff_sed_settings.GetVolumeSourceVariable()
