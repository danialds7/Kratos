...
KRATOS_TEST_CASE_IN_SUITE(MixedLaplacianElement2D3N, KratosConvectionDiffusionSedimentFastSuite)
{
    ...
    r_test_model_part.GetProcessInfo()[CONVECTION_DIFFUSION_SEDIMENT_SETTINGS]->SetGradientVariable(TEMPERATURE_GRADIENT);
...
KRATOS_TEST_CASE_IN_SUITE(MixedLaplacianElement3D4N, KratosConvectionDiffusionSedimentFastSuite)
{
    // Create the test element
    Model model;
    auto &r_test_model_part = model.CreateModelPart("TestModelPart");
