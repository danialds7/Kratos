...
#include "../test_utilities/convection_diffusion_sediment_testing_utilities.h"

namespace Kratos::Testing
{

    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionSedimentExplicit2D3N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
        ConvectionDiffusionSedimentTestingUtilities::SetEntityUnitTestModelPart(r_test_model_part);
        ...
        r_test_model_part.CreateNewElement("DConvectionDiffusionSedimentExplicit2D3N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
        ...
        p_element->FinalizeSolutionStep(process_info); // to take into account dynamic subscales
    ...
    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionSedimentExplicitOSS2D3N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
    ...
    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionSedimentExplicit3D4N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
        ...
        r_test_model_part.CreateNewElement("DConvectionDiffusionSedimentExplicit3D4N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
    ...
    KRATOS_TEST_CASE_IN_SUITE(DConvectionDiffusionSedimentExplicitOSS3D4N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
