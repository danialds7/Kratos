...
namespace Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(LaplacianElement2D3N, KratosConvectionDiffusionSedimentFastSuite)
    {
    ...
    KRATOS_TEST_CASE_IN_SUITE(LaplacianElement3D4N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
