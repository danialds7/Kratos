...
namespace Kratos::Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(QSConvectionDiffusionSedimentExplicit2D3N, KratosConvectionDiffusionSedimentFastSuite)
    {
        ...
        r_test_model_part.CreateNewElement("QSConvectionDiffusionSedimentExplicit2D3N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
    ...
    KRATOS_TEST_CASE_IN_SUITE(QSConvectionDiffusionSedimentExplicitOSS2D3N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
    ...
    KRATOS_TEST_CASE_IN_SUITE(QSConvectionDiffusionSedimentExplicit3D4N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
        ...
        r_test_model_part.CreateNewElement("QSConvectionDiffusionSedimentExplicit3D4N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
    ...
    KRATOS_TEST_CASE_IN_SUITE(QSConvectionDiffusionSedimentExplicitOSS3D4N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
