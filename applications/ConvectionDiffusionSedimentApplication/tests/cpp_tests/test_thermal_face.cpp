...
namespace Kratos::Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(ThermalFace2D2N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test condition
        Model model;
        ModelPart &test_model_part = model.CreateModelPart("TestModelPart");
        ConvectionDiffusionSedimentTestingUtilities::SetEntityUnitTestModelPart(test_model_part);
    ...
    KRATOS_TEST_CASE_IN_SUITE(ThermalFace3D3N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test condition
        Model model;
        ModelPart &test_model_part = model.CreateModelPart("TestModelPart");
    ...
    KRATOS_TEST_CASE_IN_SUITE(ThermalFace3D4N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test condition
        Model model;
        ModelPart &test_model_part = model.CreateModelPart("TestModelPart");
