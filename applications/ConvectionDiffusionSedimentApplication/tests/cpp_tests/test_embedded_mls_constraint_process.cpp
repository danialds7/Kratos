...
namespace Kratos::Testing
{
    void SetEmbeddedConstraintProcessTestModelPart(ModelPart &rModelPart)
    {
        ...
        // Set convection diffusion sediment settings
        ConvectionDiffusionSedimentSettings::Pointer p_conv_dff_set = Kratos::make_shared<ConvectionDiffusionSedimentSettings>();
        ...
        rModelPart.GetProcessInfo().SetValue(CONVECTION_DIFFUSION_SEDIMENT_SETTINGS, p_conv_dff_set);
    ...
    KRATOS_TEST_CASE_IN_SUITE(EmbeddedMLSConstraintProcess, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Get test model part
        Model model;
