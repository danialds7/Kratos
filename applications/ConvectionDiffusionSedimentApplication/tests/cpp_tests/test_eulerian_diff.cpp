...
namespace Kratos::Testing
{
    ...
    KRATOS_TEST_CASE_IN_SUITE(EulerianDiff2D3N, KratosConvectionDiffusionSedimentFastSuite)
    {
    ...
    KRATOS_TEST_CASE_IN_SUITE(EulerianDiff3D4N, KratosConvectionDiffusionSedimentFastSuite)
    {
        // Create the test element
        Model model;
        auto &r_test_model_part = model.CreateModelPart("TestModelPart");
