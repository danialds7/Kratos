...
KRATOS_TEST_CASE_IN_SUITE(AxisymmetricEulerianConvectionDiffusionSediment2D3N, KratosConvectionDiffusionSedimentFastSuite)
{
    ...
    r_test_model_part.CreateNewElement("AxisymmetricEulerianConvectionDiffusionSediment2D3N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
...
KRATOS_TEST_CASE_IN_SUITE(AxisymmetricEulerianConvectionDiffusionSediment2D4N, KratosConvectionDiffusionSedimentFastSuite)
{
    // Create the test element
    Model model;
    auto &r_test_model_part = model.CreateModelPart("TestModelPart");
    ...
    r_test_model_part.CreateNewElement("AxisymmetricEulerianConvectionDiffusionSediment2D4N", 1, elem_nodes, r_test_model_part.pGetProperties(0));
