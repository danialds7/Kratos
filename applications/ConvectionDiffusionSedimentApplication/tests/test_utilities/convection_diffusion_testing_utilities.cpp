...
#include "convection_diffusion_sediment_testing_utilities.h"


namespace Kratos::Testing
{

void ConvectionDiffusionSedimentTestingUtilities::SetEntityUnitTestModelPart(ModelPart &rModelPart)
{
    // Set buffer size
    rModelPart.SetBufferSize(2);

    // Set convection diffusion sediment settings
    auto p_conv_dff_set = Kratos::make_shared<ConvectionDiffusionSedimentSettings>();
