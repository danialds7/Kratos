...
class AdjointHeatDiffusionTest(unittest.TestCase):
    ...
    def directSensitivityCheck(self):
        ...
        with unittest.WorkFolderScope(self.work_folder, __file__):
            ...
            adjoint_analysis = ConvectionDiffusionSedimentAnalysis(model,settings["adjoint_settings"])
    ...
    def primalSolution(self, model, settings):
        ...
        primal_analysis = ConvectionDiffusionSedimentAnalysis(model,settings)
        primal_analysis.Run()
