...
class EmbeddedSolverDirichletCircleAnalysis(ConvectionDiffusionSedimentAnalysis):
    ...
    def ApplyBoundaryConditions(self):
        ...
        for elem in self._GetSolver().GetComputingModelPart().Elements:
            elem.SetValue(KratosMultiphysics.ConvectionDiffusionSedimentApplication.EMBEDDED_SCALAR, 0.0)
...
class TestEmbeddedSolver(KratosUnittest.TestCase):
    ...
    def setUp(self):
        self.work_folder = "test_convection_diffusion_sediment_embedded_solver"
    ...
    def tearDown(self):
        if not self.print_output:
            with KratosUnittest.WorkFolderScope(self.work_folder, __file__):
                ...
                KratosUtilities.DeleteFileIfExisting("test_convection_diffusion_sediment_embedded_solver.post.lst")
                KratosUtilities.DeleteFileIfExisting("test_convection_diffusion_sediment_embedded_solver_distance_modification.post.lst")
                KratosUtilities.DeleteFileIfExisting("test_convection_diffusion_sediment_embedded_solver_mls_constraints.post.lst")
