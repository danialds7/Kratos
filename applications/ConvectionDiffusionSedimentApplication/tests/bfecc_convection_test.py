...
class BFECCConvectionTest(UnitTest.TestCase):
    ...
    def runTest(self):
        with UnitTest.WorkFolderScope(self.work_folder, __file__):
            ...
            if self.has_limiter:
                bfecc_utility = ConvectionDiffusionSedimentApplication.BFECCConvection2D(locator)
            else:
                bfecc_utility = ConvectionDiffusionSedimentApplication.BFECCLimiterConvection2D(locator)
    ...
    def testBFECCNodalLimiterConvection(self):
        ...
        bfecc_utility = ConvectionDiffusionSedimentApplication.BFECCConvection2D(
            locator,
