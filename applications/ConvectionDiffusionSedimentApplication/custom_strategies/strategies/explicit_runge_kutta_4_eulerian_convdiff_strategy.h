...
/**
 * @class ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment
...
class ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment : public ExplicitSolvingStrategyRungeKutta4<TSparseSpace, TDenseSpace>
{
public:
    ///@name Type Definitions
    ///@{
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment);
     ...
     */
    explicit ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment(
    ...
    /** Copy constructor.
     */
    ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment(const ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment &Other) = delete;

    /** Destructor.
     */
    virtual ~ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment() = default;
    ...
    {
        return "ExplicitSolvingStrategyRungeKutta4ConvectionDiffusionSediment";
    }
