...
#if !defined(KRATOS_RESIDUALBASED_CONVECTION_DIFFUSION_SEDIMENT_STRATEGY_NONLINEAR )
#define  KRATOS_RESIDUALBASED_CONVECTION_DIFFUSION_SEDIMENT_STRATEGY_NONLINEAR
...
template<class TSparseSpace,
         ...
         class TLinearSolver
         >
class ResidualBasedConvectionDiffusionSedimentStrategyNonLinear
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ResidualBasedConvectionDiffusionSedimentStrategyNonLinear);
    ...
    ResidualBasedConvectionDiffusionSedimentStrategyNonLinear(
    ...
    /** Destructor.
     */
    virtual ~ResidualBasedConvectionDiffusionSedimentStrategyNonLinear()
    {
    }
...
private:
    ...
    /** Copy constructor.
     */
    ResidualBasedConvectionDiffusionSedimentStrategyNonLinear(const ResidualBasedConvectionDiffusionSedimentStrategyNonLinear& Other);
...
#endif /* KRATOS_RESIDUALBASED_CONVECTION_DIFFUSION_SEDIMENT_STRATEGY_NONLINEAR  defined */
