...
#if !defined(KRATOS_RESIDUALBASED_CONVECTION_DIFFUSION_SEDIMENT_STRATEGY )
#define  KRATOS_RESIDUALBASED_CONVECTION_DIFFUSION_SEDIMENT_STRATEGY
...
template<class TSparseSpace,
         ...
         class TLinearSolver
         >
class ResidualBasedConvectionDiffusionSedimentStrategy
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( ResidualBasedConvectionDiffusionSedimentStrategy );
    ...
    */
    ...
    ResidualBasedConvectionDiffusionSedimentStrategy(
...
//			mstep1->SetEchoLevel(2);
    ...
    /** Destructor.
    */
    virtual ~ResidualBasedConvectionDiffusionSedimentStrategy() {}
...
private:
    ...
    /** Copy constructor.
    */
    ResidualBasedConvectionDiffusionSedimentStrategy(const ResidualBasedConvectionDiffusionSedimentStrategy& Other);
...
#endif /* KRATOS_RESIDUALBASED_CONVECTION_DIFFUSION_SEDIMENT_STRATEGY  defined */
