...
#if !defined(KRATOS_CONVECTION_DIFFUSION_SEDIMENT_SETTINGS_INCLUDED )
#define  KRATOS_CONVECTION_DIFFUSION_SEDIMENT_SETTINGS_INCLUDED
...
/// Convection diffusion Sediment settings. This class contains information to be used by the Convection diffusion Sediment solver, all the variables that will be needed by the solver.
/** All the variables needed by any Convection diffusion Sediment problem are included here. However, many problems do not require such a large amount of variables.
...
*/
class KRATOS_API(KRATOS_CORE) ConvectionDiffusionSedimentSettings
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of ConvectionDiffusionSedimentSettings
    KRATOS_CLASS_POINTER_DEFINITION(ConvectionDiffusionSedimentSettings);
    ...
    /// Default constructor.
    ConvectionDiffusionSedimentSettings() = default;

    ConvectionDiffusionSedimentSettings(const ConvectionDiffusionSedimentSettings& rOther):
    ...
    /// Destructor.
    virtual ~ConvectionDiffusionSedimentSettings() {};
    ...
    ///@{
    /// Assignment operator.
    ConvectionDiffusionSedimentSettings& operator=(ConvectionDiffusionSedimentSettings const& rOther)
    {
        mpDensityVar = rOther.mpDensityVar;
        mpDiffusionVar = rOther.mpDiffusionVar;
        mpUnknownVar = rOther.mpUnknownVar;
    ...
    virtual std::string Info() const
    {
        ...
        buffer << "ConvectionDiffusionSedimentSettings #" ;
        return buffer.str();
    }
    ...
    {
        rOStream << "ConvectionDiffusionSedimentSettings #";
    }
...
}; // Class ConvectionDiffusionSedimentSettings
...
inline std::istream& operator >> (std::istream& rIStream,
                                  ConvectionDiffusionSedimentSettings& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator << (std::ostream& rOStream,
                                  const ConvectionDiffusionSedimentSettings& rThis)
{
...
KRATOS_DEFINE_VARIABLE(ConvectionDiffusionSedimentSettings::Pointer, CONVECTION_DIFFUSION_SEDIMENT_SETTINGS)
...
#endif // KRATOS_CONVECTION_DIFFUSION_SEDIMENT_SETTINGS_INCLUDED  defined
