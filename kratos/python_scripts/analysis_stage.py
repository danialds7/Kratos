...
class AnalysisStage(object):
    ...
    def Initialize(self):
        ...
        This function has to be implemented in deriving classes!P
        """
        # Modelers:
        ...
        model_part_name = self.project_parameters["solver_settings"]["fluid_solver_settings"]["model_part_name"].GetString()

        # Initialize remaining nodes
        density = self.project_parameters["solver_settings"]["fluid_solver_settings"]["density"].GetDouble()
        small_value = 1e-4
        active_node_count = 0
