...
//KRATOS_CREATE_VARIABLE(ConvectionDiffusionSedimentSettings::Pointer, CONVECTION_DIFFUSION_SEDIMENT_SETTINGS)

void ConvectionDiffusionSedimentSettings::save(Serializer& rSerializer) const
{
    KRATOS_TRY
...
void ConvectionDiffusionSedimentSettings::load(Serializer& rSerializer)
{
    KRATOS_TRY
