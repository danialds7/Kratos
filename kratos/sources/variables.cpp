...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(C_SUSP_GRADIENT)
KRATOS_CREATE_VARIABLE(double,C_SUSP_FLUX)
KRATOS_CREATE_VARIABLE(double,C_SUSP_FACE_FLUX)
...
void KratosApplication::RegisterVariables() {
    ...
    // sediement transport application
    KRATOS_REGISTER_VARIABLE(C_SUSP)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(C_SUSP_GRADIENT)
    ...
    KRATOS_REGISTER_VARIABLE(CONVECTION_DIFFUSION_SEDIMENT_SETTINGS)
